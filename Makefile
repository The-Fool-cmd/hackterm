...
SRC = src/main.c src/ui/state.c src/ui/init.c src/ui/output.c src/ui/input.c src/ui/render.c src/commands.c src/core_commands.c src/game.c src/server.c src/script.c src/script_api.c
OBJ = $(SRC:.c=.o)
